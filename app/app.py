...
def Visualization(county):
    ...
    if master_data is not None:
        ...
        return render_template('results.html', population=population, pop_label=pop_label, covid_incidents=covid_incidents, covid_deaths=covid_deaths,  median_income=median_income, fl_pct_county=fl_pct_county, fl_pct_state=fl_pct_state)
    else:
        return render_template('index.html')
